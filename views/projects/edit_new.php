                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                ?>
                                <?php if ($daysLeft < 0): ?>
                                    <small class="text-danger">(<?= abs($daysLeft) ?> dias em atraso)</small>
                                <?php elseif ($daysLeft <= 7): ?>
                                    <small class="text-warning">(<?= $daysLeft ?> dias restantes)</small>
                                <?php else: ?>
                                    <small class="text-success">(<?= $daysLeft ?> dias restantes)</small>
                                <?php endif; ?>
                            </div>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="card mt-3">
                        ...
                        <div class="card-body">
                            <div class="alert alert-info">
                                <h6 class="alert-heading">💡 Dicas Importantes</h6>
                                <ul class="mb-0">
                                    <li><i class="fas fa-check text-success me-2"></i>Seja claro na descrição</li>
